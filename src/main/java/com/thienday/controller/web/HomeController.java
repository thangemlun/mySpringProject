...
public class HomeController {
	...
	public ModelAndView homePage() {
		...
		if (categoryTheThao != null) {
			newsModelTheThao.setListResult(newsService.findAll(categoryTheThao.getName()));
			newsModelTheThao.getListResult().forEach((news) -> news
					.setTimeNewsPosted(new SimpleDateFormat("yyyy/MM/dd HH:mm").format(news.getCreatedDate())));
		}
	...
	@RequestMapping(value = "/PageNotFound" , method = RequestMethod.GET ,produces = MediaType.APPLICATION_XHTML_XML_VALUE)
	...
	public ModelAndView testResourceNotFoundException( HttpServletRequest request ,HttpServletResponse response) throws ResourceNotFoundException {
