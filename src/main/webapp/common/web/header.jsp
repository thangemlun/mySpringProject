...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	<div class="container">
		<a class="navbar-brand" href="<c:url value='/trang-chu'/>"><img src="https://i.imgur.com/GZsmERh.png" width="75%"></a>
			...
			<ul class="navbar-nav ml-auto">
				...
				<security:authorize access = "isAuthenticated()">
					...
					<li class="nav-item">
				        ...
				        <div id="resultList"  style ="position:absolute;width: 450px;">
							  <%-- <img src="<c:url value='/template/web/icon/LOGO.png'/>" width="50%" height="45px"> --%>
							    <ul id="suggestSearchNewsList"  class="list-group" style="min-height:100%;overflow-y:scroll;" ></ul>						  
						</div>
				    </li>
			</ul>
		</div>
