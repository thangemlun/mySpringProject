...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
		...
		<div class="row align-items-center my-5">
			<div class="col-lg-7">
				<a href="${newsURL}"><img class="img-fluid rounded mb-4 mb-lg-0" src="<c:url value ='/image-response/${newestNews.thumbnail}'/>" alt="" width="100%" height="360"></a>
			</div>
			<!-- /.col-lg-8 -->
			<div class="col-lg-5">
				<h1 class="font-weight-light"><a href="${newsURL}" class="list-group-item list-group-item-action flex-column align-items-start">${newestNews.title}</a></h1>
        ...
        <c:forEach var="item" items="${newsModelTheThao.listResult}" >
			<div class="col-md-4">
              ...
              <c:url var="newsItemURL" value="/bai-viet">
               ...
               <a href="${newsItemURL}"><img class="card-img-top" src="<c:url value ='/image-response/${item.thumbnail}'/>" width="100%" height="200" data-holder-rendered="true"></a>
                <div class="card-body">
                  <a href="${newsItemURL}"class="list-group-item list-group-item-action flex-column align-items-start">
                  	<%-- <p class="h4">${item.title}</p> --%>
                  	<h3> ${item.title}</h3> 
					  <div id="description"><h5 style="white-space:nowrap; width: 100%; overflow:hidden; text-overflow:ellipsis"><small class="text-muted">${item.shortDescription}</small></h5></div>
              ...
              <c:url var="newsItemURL" value="/bai-viet">
				  ...
				  <a href="${newsItemURL}"><img class="card-img-top" src="<c:url value ='/image-response/${item.thumbnail}'/>" width="100%" height="200" data-holder-rendered="true"></a>
	                <div class="card-body">
					  <a href="${newsItemURL}"class="list-group-item list-group-item-action flex-column align-items-start">
	                  	<h3> ${item.title}</h3> 
						  <div id="description_${item.id}"><h5 style="white-space:nowrap; width: 100%; overflow:hidden; text-overflow:ellipsis"><small class="text-muted">${item.shortDescription}</small></h5></div>
		                  <div class="d-flex justify-content-between align-items-center">
		                    <small class="text-muted" id="timePosted_${item.id}"></small>  
		                  </div>
	                  </a>
			...
			<div class="col-md-4">
              <div class="card mb-4 box-shadow">
               <c:url var="newsItemURL" value="/bai-viet">
				  ...
				  <a href="${newsItemURL}"><img class="card-img-top" src="<c:url value ='/image-response/${item.thumbnail}'/>" width="100%" height="200" data-holder-rendered="true"></a>
	                <div class="card-body">
					  <a href="${newsItemURL}"class="list-group-item list-group-item-action flex-column align-items-start" id="description_${item.id}">
	                  	<h3> ${item.title}</h3> 
						  <h5 id="shortDescription_${item.id}" style="white-space:nowrap; width: 100%; overflow:hidden; text-overflow:ellipsis"><small class="text-muted">${item.shortDescription}</small></h5>
		                  <div class="d-flex justify-content-between align-items-center">
		                    <small class="text-muted" id="timePosted_${item.id}"></small>  
		                  </div>
	                  </a>
