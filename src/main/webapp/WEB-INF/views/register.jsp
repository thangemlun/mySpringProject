...
<body>
<div class="card bg-light" width="100%" style="margin-left: 38% ;margin-top:5% ; margin-bottom:5% ; position:relative "><!-- style="margin-left: 39% ;margin-top:0% ; margin-bottom:5% ; position:relative " -->
